...
}
{
  ...
  for name in \
    ...
    LISTINGIFY_PRODUCT_ARCHIVE_SYNC_CONCURRENCY \
    LISTINGIFY_PRODUCT_ARCHIVE_PUBLISH_CONCURRENCY \
    LISTINGIFY_PRODUCT_ARCHIVE_AI_FILL_ITEM_CONCURRENCY \
    LISTINGIFY_PRODUCT_ARCHIVE_BULK_INSERT_BATCH_SIZE \
    LISTINGIFY_PRODUCT_ARCHIVE_JOB_LEASE_MS \
