...
const LAUNCH_PLAN_FIELD_HINTS = new Set(["款号", "大货款号", "货号", "吊牌价", "吊牌价格", "核算吊牌价", "挂牌单价", "颜色", "颜色名称", "上市时间", "内容上市时间", "搜索上市时间", "首批sap到货时间", "首批 SAP 到货时间", "产品季", "对应日期", "官方发布类目", "发布类目", "发布类目 (官方)", "发布类目(官方)", "发布类目 (唯品)", "发布类目(唯品)", "发布类目 (抖音)", "发布类目(抖音)", "主款式 （唯品四级品类）", "主款式（唯品四级品类）", "主款式", "属性", "SKU", "SKC", "单品货号", "唯品会货号", "小红书商家编码", "鞋品生产企业名称", "鞋品企业名称", "生产企业名称"]);
const COPYWRITING_FIELD_HINTS = new Set(["FAB", "搜索标题", "商品标题", "标题", "唯品标题", "唯品会标题", "内容平台标题", "内容标题", "导购标题", "推荐理由", "面料成分", "材质成分", "大身面料", "帮面材料", "帮面材质", "里料材质", "内里材质", "鞋底材质", "品类", "名称", "商品名称", "年龄段", "尺码段", "性别", "面料名称", "面料文案", "面料三个关键词", "细节文案", "主图4第1句", "主图4第2-3句", "面料名称-面料文案*面料三个关键词", "柔软度", "厚薄", "弹性", "去掉巴拉巴拉"]);
