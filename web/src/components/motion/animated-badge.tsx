// Adapted from beUI (MIT). See web/BEUI-LICENSE.txt.
"use client";
...
const STATUS_CLASS: Record<AnimatedBadgeStatus, string> = {
  ...
  info: "border-[var(--brand-deep)]/20 bg-[var(--brand-light)]/60 text-[#08794f]",
  success: "border-emerald-500/30 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400",
  warning: "border-amber-500/30 bg-amber-500/10 text-amber-600 dark:text-amber-400",
  danger: "border-destructive/30 bg-destructive/10 text-destructive",
  loading: "border-[var(--brand-deep)]/20 bg-[var(--brand-light)]/60 text-[#08794f]",
};
...
export function AnimatedBadge({
  ...
  return (
    ...
    >
      ...
      {showIcon ? (
        <span aria-hidden className="relative z-10 inline-flex items-center justify-center overflow-hidden">
          <AnimatePresence mode="popLayout" initial={false}>
            ...
            >
              {status === "loading" && animateIcon && !reduce && !icon ? (
                <motion.span
                  animate={{ rotate: 360 }}
      ...
      {children != null ? (
        <span aria-hidden className="relative z-10 inline-flex overflow-hidden">
          <AnimatePresence mode="popLayout" initial={false}>
            <motion.span
